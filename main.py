...
if uploaded_file is not None:
    ...
    df['Business Address on Business Card: Address'] = df['Business Address on Business Card: Address'].fillna(
        value="")
    df['Business Address on Business Card: Address 2'] = df['Business Address on Business Card: Address 2'].fillna(
        value="")
    df['Business Address on Business Card: City '] = df['Business Address on Business Card: City '].fillna(
        value="")
    df['Business Address on Business Card: State'] = df['Business Address on Business Card: State'].fillna(
        value="")
